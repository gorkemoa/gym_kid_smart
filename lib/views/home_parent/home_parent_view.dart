...
class HomeParentView extends StatefulWidget {
  const HomeParentView({super.key});

  @override
  State<HomeParentView> createState() => _HomeParentViewState();
}

class _HomeParentViewState extends State<HomeParentView> {
  int _currentIndex = 0;
