...
import '../student_history/widgets/student_history_activity_card.dart';
import '../student_history/widgets/student_history_package_card.dart';

class StudentActivityDetailView extends StatefulWidget {
  final OyunGrubuStudentModel student;

  const StudentActivityDetailView({super.key, required this.student});

  @override
  State<StudentActivityDetailView> createState() =>
      _StudentActivityDetailViewState();
}

class _StudentActivityDetailViewState extends State<StudentActivityDetailView>
